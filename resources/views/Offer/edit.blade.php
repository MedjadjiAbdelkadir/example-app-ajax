                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('offers.update',$offer->id)}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$offer->name}}" id="name" name="name" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputDescription">Description</label>
                                <input value="{{$offer->desc}}"  name="desc" id="desc" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputClientCompany">Prix</label>
                                <input type="text"value="{{$offer->prix}}"  id="prix" name="prix" class="form-control">
                            </div>
                            <div class="form-group">
                                <button type="submit" id="update_offer" class="btn btn-success">Update</button>
                            </div>
                        </form>
